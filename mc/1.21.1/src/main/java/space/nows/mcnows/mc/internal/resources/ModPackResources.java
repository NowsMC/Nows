...
final class ModPackResources implements PackResources {
    ...
    ModPackResources(PackLocationInfo location, Path jar) throws IOException {
    ...
    public void listResources(PackType type, String namespace, String path, ResourceOutput output) {
        ...
        zip.stream()
                ...
                .forEach(name -> {
                    ...
                    ResourceLocation id = ResourceLocation.tryBuild(namespace, resourcePath);
                    if (id == null) {
                        return;
                    }
    ...
    public Set<String> getNamespaces(PackType type) {
        ...
        zip.stream()
                ...
                .filter(namespace -> ResourceLocation.isValidNamespace(namespace))
