...
package space.nows.mc.internal.client.player;
...
import space.nows.mc.api.client.player.PlayerSnapshot;
...
public final class PlayerApiImpl implements PlayerApi {
    ...
    public int selectedHotbarSlot() {
        return requireCurrent().inventory.selected;
    }

    @Override
    public ItemStack selectedItem() {
        return requireCurrent().inventory.getSelected();
    }
    ...
    public boolean addItem(ItemStack item) {
        return requireCurrent().inventory.add(item);
    }
    ...
    public void setInventoryItem(int slot, ItemStack item) {
        requireCurrent().inventory.setItem(slot, item);
    }
    ...
    public void setSelectedHotbarSlot(int slot) {
        Inventory inventory = requireCurrent().inventory;
