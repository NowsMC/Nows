...
public final class SimpleConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(width / 2 - 124, height - 28, 118, 20, new TextComponent("Save"), button -> saveAndClose()));
        addRenderableWidget(new Button(width / 2 + 6, height - 28, 118, 20, new TextComponent("Cancel"), button -> onClose()));
    }
    ...
    private void addOptionButton(int left, int y, int contentWidth, ConfigOptionSpec option) {
        ...
        addRenderableWidget(new Button(left, y, 28, 20, new TextComponent("-"), button -> {
                    option.add(-1);
                    clearWidgets(); init();
                }));
        ...
        addRenderableWidget(new Button(left + contentWidth - 28, y, 28, 20, new TextComponent("+"), button -> {
                    option.add(1);
                    clearWidgets(); init();
                }));
    }
