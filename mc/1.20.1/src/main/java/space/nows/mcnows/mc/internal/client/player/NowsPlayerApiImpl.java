...
import space.nows.mcnows.mc.api.client.player.NowsPlayerSnapshot;

import java.util.Optional;

public final class NowsPlayerApiImpl implements NowsPlayerApi {
    @Override
    ...
    @Override
    public NowsPlayerSnapshot snapshot() {
        LocalPlayer player = requireCurrent();
        Abilities abilities = player.getAbilities();
        return new NowsPlayerSnapshot(
                player.getUUID(),
    ...
    public int selectedHotbarSlot() {
        return requireCurrent().getInventory().selected;
    }

    @Override
    public ItemStack selectedItem() {
        return requireCurrent().getInventory().getSelected();
    }
