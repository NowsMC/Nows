...
public final class NowsModListScreen extends Screen {
    private static final ResourceLocation FALLBACK_ICON = ResourceLocation.tryParse("nows_api_mod:textures/gui/mod_menu_icon.png");
    ...
    private final class ModEntry extends ObjectSelectionList.Entry<ModEntry> {
        ...
        public void render(
            ...
            graphics.blit(icon, x, y, 0, 0, 22, 22, 22, 22);
    ...
    private static final class ModDetailsPanel extends AbstractScrollWidget {
