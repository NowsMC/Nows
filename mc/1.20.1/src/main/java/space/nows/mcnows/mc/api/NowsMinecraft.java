...
public final class NowsMinecraft {
    ...
    public static NowsPlayerApi players(NowsContext context) {
        return context.service(NowsPlayerApi.class);
    }

    public static NowsPlayerApi player(NowsContext context) {
